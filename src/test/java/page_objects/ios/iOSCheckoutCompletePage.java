...
/**
 * iOS implementation of the checkout completion page.
 * Provides verification of successful order completion and navigation back home.
 */
public class iOSCheckoutCompletePage extends BaseMobilePage<CheckoutCompletePageInterface.Element> implements CheckoutCompletePageInterface {

  private static final Logger LOGGER = LoggerFactory.getLogger(iOSCheckoutCompletePage.class);

  @iOSXCUITFindBy(id = "back-home-button")
  private WebElement backHomeButton;

  public iOSCheckoutCompletePage(AppiumDriver driver) {
    super(driver);
  }
    ...
    return switch (element) {
      ...
      case THANK_YOU_HEADER -> new WebElement[] {
          driver.findElement(By.xpath(
              "//XCUIElementTypeStaticText[contains(translate(@name,'THANK YOU','thank you'),'thank you for your order')]"))};
      default -> null;
    };
  }
